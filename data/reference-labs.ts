...
export const REFERENCE_LABS: ReferenceEntry[] = [
  ...
  },
  {
    ...
    specimen: 'blood',
    interpretation: 'ours',
    aliases: ['ALT', 'GPT', '谷丙转氨酶', '丙氨酸氨基转移酶', '丙氨酸氨基转氨酶'],
  ...
  },
  {
    ...
    specimen: 'blood',
    interpretation: 'ours',
    aliases: ['AST', 'GOT', '谷草转氨酶', '天冬氨酸氨基转移酶', '天门冬氨酸氨基转移酶'],
    unit: 'U/L', allowedUnits: ['U/L', 'IU/L'],
  ...
  // canonical SI unit (cross-scale conversions are handled in M2, not here).
  {
    ...
    specimen: 'blood',
    interpretation: 'ours',
    aliases: ["MCH", "平均血红蛋白量", "平均红细胞血红蛋白含量", "红细胞平均血红蛋白量", "均血红蛋白里", '平均血红蛋白含量'],
  ...
  },
  {
    ...
    specimen: 'blood',
    interpretation: 'ours',
    aliases: ["MONO%", "单核细胞百分数", "单核细胞比率", "单核细胞百分比"],
    unit: "%", allowedUnits: ["%"],
    refLow: 3, refHigh: 10,
    criticalLow: null, criticalHigh: null, highStakes: false, populationSensitive: false,
    absoluteLow: 0, absoluteHigh: 100,
  ...
  },
  {
    ...
    specimen: 'blood',
    interpretation: 'ours',
    aliases: ["EOS%", "嗜酸性粒细胞百分数", "嗜酸性粒细胞比率", "嗜酸细胞百分比", "嗜酸性粒细胞百分比"],
    unit: "%", allowedUnits: ["%"],
  ...
  },
  {
    ...
    specimen: 'blood',
    interpretation: 'ours',
    aliases: ["BASO%", "嗜碱性粒细胞百分数", "嗜碱性粒细胞比率", "嗜碱细胞百分比", '嗜碱性粒细胞百分比'],
    unit: "%", allowedUnits: ["%"],
    refLow: 0, refHigh: 1,
    criticalLow: null, criticalHigh: null, highStakes: false, populationSensitive: false,
    absoluteLow: 0, absoluteHigh: 100,
  ...
  },
  {
    ...
    specimen: 'blood',
    interpretation: 'ours',
    aliases: ["non-HDL-C", "非HDL胆固醇", "非高密度脂蛋白胆固醇", "non-HDL", '非高密度脂蛋白'],
    unit: "mmol/L", allowedUnits: ["mmol/L"],
  ...
  },
  {
    ...
    specimen: 'blood',
    interpretation: 'ours',
    aliases: ["TPOAb", "TPO-Ab", "anti-TPO", "TPO antibody", "抗甲状腺过氧化物酶抗体", "抗TPO抗体", "TPO抗体", '甲状腺过氧化物酶抗体'],
  ...
  },
  {
    ...
    specimen: 'blood',
    interpretation: 'ours',
    aliases: ["25-OH Vitamin D", "25(OH)D", "Vitamin D", "维生素D", "25-羟维生素D", "总25羟维生素D", 'Vita25-羟基维生素D'],
    unit: "nmol/L", allowedUnits: ["nmol/L"],
  ...
  },
  {
    ...
    specimen: 'blood',
    interpretation: 'ours',
    aliases: ['EO#', 'EOS#', '嗜酸性粒细胞绝对值', '嗜酸性粒细胞计数', '嗜酸性粒细胞数'],
    unit: '10^9/L', allowedUnits: ['10^9/L', '10*9/L', 'x10^9/L', '×10^9/L', 'G/L'],
  ...
  boneDensitometry({
    ...
    definition: defineText({
      en: reviewed('How much bone mineral there is in each square centimetre of bone, at the site labelled T11 on your report.'),
      zh: reviewed('报告上标注为 T11 的部位，每平方厘米骨头里含有多少骨矿物质。'),
      bo: fallback('zh'),
    }),
  }),
  boneDensitometry({
  ...
  boneDensitometry({
    ...
    allowedUnits: ['SD'],
    definition: defineText({
      en: reviewed('The bone density measured at the site labelled T11 on your report, compared with the bone density of same-sex young adults at their peak, as a number of standard deviations.'),
      zh: reviewed('把报告上标注为 T11 的部位所测的骨密度，和同性别年轻人骨头最结实时候的骨密度比一比，相差几个标准差。'),
      bo: fallback('zh'),
    }),
  }),
  boneDensitometry({
    ...
    allowedUnits: ['SD'],
    definition: defineText({
      en: reviewed('The bone density measured at the site labelled T11 on your report, compared with the average for people of the same sex and age, as a number of standard deviations.'),
      zh: reviewed('把报告上标注为 T11 的部位所测的骨密度，和同性别、同岁数人的平均骨密度比一比，相差几个标准差。'),
      bo: fallback('zh'),
    }),
  }),
  boneDensitometry({
    ...
    allowedUnits: ['g/cm2', 'g/cm²', 'g/cm^2'],
    definition: defineText({
      en: reviewed('How much bone mineral there is in each square centimetre of bone, at the site labelled T12 on your report.'),
      zh: reviewed('报告上标注为 T12 的部位，每平方厘米骨头里含有多少骨矿物质。'),
      bo: fallback('zh'),
    }),
  }),
  boneDensitometry({
  ...
  boneDensitometry({
    ...
    allowedUnits: ['SD'],
    definition: defineText({
      en: reviewed('The bone density measured at the site labelled T12 on your report, compared with the bone density of same-sex young adults at their peak, as a number of standard deviations.'),
      zh: reviewed('把报告上标注为 T12 的部位所测的骨密度，和同性别年轻人骨头最结实时候的骨密度比一比，相差几个标准差。'),
      bo: fallback('zh'),
    }),
  }),
  boneDensitometry({
    ...
    allowedUnits: ['SD'],
    definition: defineText({
      en: reviewed('The bone density measured at the site labelled T12 on your report, compared with the average for people of the same sex and age, as a number of standard deviations.'),
      zh: reviewed('把报告上标注为 T12 的部位所测的骨密度，和同性别、同岁数人的平均骨密度比一比，相差几个标准差。'),
      bo: fallback('zh'),
    }),
  }),
  boneDensitometry({
    ...
    allowedUnits: ['g/cm2', 'g/cm²', 'g/cm^2'],
    definition: defineText({
      en: reviewed('How much bone mineral there is in each square centimetre of bone, at the site labelled L1 on your report.'),
      zh: reviewed('报告上标注为 L1 的部位，每平方厘米骨头里含有多少骨矿物质。'),
      bo: fallback('zh'),
    }),
  }),
  boneDensitometry({
  ...
  boneDensitometry({
    ...
    allowedUnits: ['SD'],
    definition: defineText({
      en: reviewed('The bone density measured at the site labelled L1 on your report, compared with the bone density of same-sex young adults at their peak, as a number of standard deviations.'),
      zh: reviewed('把报告上标注为 L1 的部位所测的骨密度，和同性别年轻人骨头最结实时候的骨密度比一比，相差几个标准差。'),
      bo: fallback('zh'),
    }),
  }),
  boneDensitometry({
    ...
    allowedUnits: ['SD'],
    definition: defineText({
      en: reviewed('The bone density measured at the site labelled L1 on your report, compared with the average for people of the same sex and age, as a number of standard deviations.'),
      zh: reviewed('把报告上标注为 L1 的部位所测的骨密度，和同性别、同岁数人的平均骨密度比一比，相差几个标准差。'),
      bo: fallback('zh'),
    }),
  }),
  boneDensitometry({
    ...
    allowedUnits: ['g/cm2', 'g/cm²', 'g/cm^2'],
    definition: defineText({
      en: reviewed('How much bone mineral there is in each square centimetre of bone, for the row labelled 均值 (mean) on your report.'),
      zh: reviewed('报告上标注为“均值”一行，每平方厘米骨头里含有多少骨矿物质。'),
      bo: fallback('zh'),
    }),
  }),
  boneDensitometry({
  ...
  boneDensitometry({
    ...
    allowedUnits: ['SD'],
    definition: defineText({
      en: reviewed('The bone density on the row labelled 均值 (mean) on your report, compared with the bone density of same-sex young adults at their peak, as a number of standard deviations.'),
      zh: reviewed('把报告上标注为“均值”一行的骨密度，和同性别年轻人骨头最结实时候的骨密度比一比，相差几个标准差。'),
      bo: fallback('zh'),
    }),
  }),
  boneDensitometry({
    ...
    allowedUnits: ['SD'],
    definition: defineText({
      en: reviewed('The bone density on the row labelled 均值 (mean) on your report, compared with the average for people of the same sex and age, as a number of standard deviations.'),
      zh: reviewed('把报告上标注为“均值”一行的骨密度，和同性别、同岁数人的平均骨密度比一比，相差几个标准差。'),
      bo: fallback('zh'),
    }),
  }),
];
