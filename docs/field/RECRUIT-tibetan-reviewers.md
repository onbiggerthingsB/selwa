...
传统藏医（索瓦日巴）有一套成熟的技术词汇，与现代医学概念**并不对应**。翻译时最容易出的错，就是顺手用了一个传统术语——那个词对藏族老人来说熟悉、权威、可信，**但它指的是另一回事**。这类错误不长得像错误，词典查不出来。

目前已确认两个词，请特别留意：

**ཉེས་པ (nyes pa)** —— 日常义是「过失、毛病、问题」，但在藏医里是**三因（三种体液）的统称**。
如果界面提示语中「异常」「有问题」这类词被译成 nyes pa，一位熟悉藏医的老人可能会把它读成**体液失衡的诊断**。而本应用刻意不做任何诊断。请避开。

**རླུང (rlung)** —— 日常义是「风、气」，同时也是藏医中主管循环、神经、睡眠与情绪的一种体液。同一个词在不同语境下意思完全不同。

这两个词是目前**已知**的。如果您在翻译中遇到其他类似的词——日常听起来普通、但在藏医里有特定含义——**请单独记下来告诉我们。这部分对我们的价值可能比翻译本身还大。**
